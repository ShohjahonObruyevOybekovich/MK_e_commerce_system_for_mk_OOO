...
from account.serializers import UserLoginSerializer, ConfirmationCodeSerializer, PasswordResetRequestSerializer, \
    PasswordResetLoginSerializer, UserListSerializer, UserSerializer
from .serializers import UserCreateSerializer, UserUpdateSerializer
from rest_framework import status
from account.tasks import send_email, send_forget_password
